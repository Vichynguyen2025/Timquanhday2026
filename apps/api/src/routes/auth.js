...
router.get('/me', authenticate, async (req, res) => {
  try {
    const user = await queryOne('SELECT id, name, email, phone, avatar, avatar_version, bio, gender, birth_year, hometown, occupation, school, location_enabled, is_online, last_seen, created_at FROM users WHERE id = ?', [req.user.id]);
